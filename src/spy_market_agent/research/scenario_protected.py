...
from spy_market_agent.research.scenario_candidate import MI1D_CANDIDATE_ID, MI1D_FEATURE_POLICY_ID
...
class MI1FrozenPolicyBundle:
    ...
    def __post_init__(self) -> None:
        ...
        if self.selectivity_policy is not None and self.selectivity_policy.policy_id != MI1F_SELECTIVITY_POLICY_ID:
        ...
        object.__setattr__(self, "frozen_at", _aware_utc(self.frozen_at, field_name="frozen_at"))
...
class MI1ProtectedEvaluationResult:
    ...
    def __post_init__(self) -> None:
        ...
        if not math.isclose(self.selected_coverage, self.selected_rows / self.row_count, abs_tol=1e-12):
        ...
        if self.selected_rows == 0:
            ...
            if self.selected_precision is None or not math.isclose(
