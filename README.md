...
- Timeout or uncertain submission records `submission_unknown`, does not retry automatically, and requires explicit read-only reconciliation by `client_order_id`.
