...
ignored under `artifacts/research/<experiment_id>/`. The Phase 3 CLI is manual, offline
after data acquisition, credential-free, broker-free, and unable to submit paper or live
orders. Protected evaluation, Phase 4 shadow mode, and strategy optimization remain
unauthorized.
